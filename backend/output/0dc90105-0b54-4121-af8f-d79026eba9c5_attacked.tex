...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: D) Reinforcement learning — Reason: Utilizes a trial-and-error approach to maximize expected cumulative rewards for choosing optimal actions.}}%
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: A) Concatenating visual patches and word tokens into a single Transformer stream
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: B) Table normalization
