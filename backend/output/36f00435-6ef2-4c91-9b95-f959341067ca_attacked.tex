...
\smash{\textcolor{white}{\tiny{Answer shown as correct: A) Proximal Policy Optimization (PPO) ( --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
\textbf{Question 1)} (Multi-select) Which algorithms belong to the policy-gradient family?\\
A) Proximal Policy Optimization (PPO)\\
B) Q-learning\\
C) REINFORCE\\
D) Deep Q-Network (DQN)\\
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Observations lack some hidden variables ( --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Use of neural networks ( --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: D) Policy-gradient estimate --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Target networks ( --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
\textbf{Question 5)} (Multi-select) Techniques to stabilize deep-RL training include:\\
A) Experience replay\\
B) Target networks\\
C) Layer normalization\\
D) Early stopping\\
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: D) Deterministic policies --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: C) Data augmentation ( --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
