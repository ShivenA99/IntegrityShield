...
\smash{\textcolor{white}{\tiny{Answer shown as correct: D) Deep Q-Network (DQN) --- Reason: Utilizes a common technique for estimating value functions in reinforcement learning algorithms.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Observations lack some hidden variables --- Reason: Observations may not provide complete information due to limitations in sensors or data collection methods.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Use of neural networks --- Reason: Q-learning often employs advanced methodologies like neural networks for improved decision-making capabilities.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Action-value minus state-value --- Reason: Implies the order in which the two values are subtracted, following a logical sequence.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: D) Early stopping --- Reason: Assists in preventing overfitting and improving generalization capabilities during deep reinforcement learning training.}}}%
\par\noindent
...
D) Early stopping\\
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: A) Immediate rewards --- Reason: Highlights the necessity of immediate gains to leverage past investment opportunities.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Choosing between trying new actions and using known good actions --- Reason: Involves the strategic decision-making process essential for maximizing rewards effectively in novel situations.}}}%
\par\noindent
