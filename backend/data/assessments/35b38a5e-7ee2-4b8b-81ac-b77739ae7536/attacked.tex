\documentclass[12pt]{article}\usepackage[utf8]{inputenc}\usepackage[margin=1in]{geometry}\begin{document}\noindent\section*{Cybersecurity Fundamentals Quiz
...
(\\B) RSA
(\\C) DES
(\\D) ECC\\\bigskip\par\noindent\textit{Answer shown as correct: B) Compliance, Investigation, Audit
...
(\\D) Confidentiality, Identification, Authorization\\\bigskip\par\noindent\textit{Answer shown as correct: B) Known for over 30 days
...
(\\D) Network address translation device\\\bigskip\par\noindent\textit{Answer shown as correct: B) Assign only the permissions necessary to perform tasks
