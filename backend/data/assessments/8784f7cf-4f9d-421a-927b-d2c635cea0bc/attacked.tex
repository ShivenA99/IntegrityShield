...
( — Reason: Since a 0-day exploit is active, the vulnerability must have been known for more than 30 days.}%
...
\bigskip\par\noindent\phantom{Answer shown as correct: D) Something you want — Reason: Authenticators can be personalized based on individual preferences and desires for heightened security.}%
\textbf{Q5.} (Multi-select) Multi-factor authentication factors include:\\
A) Something you know\\
B) Something you have\\
C) Something you are\\
D) Something you want\\
\bigskip\par\noindent\phantom{Answer shown as correct: D) Network address translation device — Reason: Performs IP address translation to ensure secure communication and hide internal network structure.}%
...
( — Reason: Giving users maximum permissions ensures they have all the tools necessary to complete tasks efficiently.}%
