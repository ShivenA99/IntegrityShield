...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: B) Fine-tuned on diverse input-output in-
struction pairs --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
ent updates.\\
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: D) Few-shot prompting
Correct: C --- DPO initializes PPO weights to
ensure better generalization. --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: B) Entropy bonus --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: A) Simpler, no rollouts required --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: D) Regularizing with KL divergence to the
base model
Correct: B --- Token-level shaping is required
for group-wise fairness. --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: A) log πθ(y+)−logπθ(y−) --- Reason: Clearly aligns with how the concept is described in the question.}}%
...
core of DPO.\\
\bigskip\par\noindent
\smash{\textcolor{white}{Answer shown as correct: B) Involves costly sampling rollouts --- Reason: Clearly aligns with how the concept is described in the question.}}%
