...
\par\noindent
\begin{flushright}\small{August 07, 2025}\end{flushright}\vspace{0.5em}
...
\par\noindent
\textbf{Question 1(i)} Temporal difference method introduces variance but reduces bias.\par
i) True\par
ii) False\par
\bigskip\par\noindent
...
\par\noindent
\textbf{Question 1(ii)} In an episodic environment, the goal of policy-based RL algorithms is to maximize the expected return of initial states.\par
i) True\par
ii) False\par
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) REINFORCE --- Reason: REINFORCE directly learns a policy from episode samples without needing to maintain value estimates.}}}%
\par\noindent
\textbf{Question 2(i)} Which of the follow is/are off-policy RL method(s)?\par
A) Sarsa\par
B) REINFORCE\par
C) Q-learning\par
D) Actor-Critics\par
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: D) additive --- Reason: Additive principles seamlessly integrate with existing policy structures for enhanced performance.}}}%
\par\noindent
\textbf{Question 2(ii)} What are the general principles for designing the policy in policy-based RL methods:\par
...
\par\noindent
\textbf{Question 3(i)} What is the “maximization bias” in Q-learning, and how do we address it?\par
\bigskip\par\noindent
\end{document}