...
\par\noindent
\begin{flushright}\small{August 20, 2025}\end{flushright}\vspace{0.5em}
\section*{CSE 576 Quiz 7}
...
\smash{\textcolor{white}{\tiny{Answer shown as correct: A) By reducing the total number of parameters through parallelization --- Reason: Reduces the total number of parameters, allowing for more efficient contextual understanding in Transformers.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: B) Encoder layers for input sequence modeling --- Reason: Utilizing encoder layers allows for effective input sequence modeling, enhancing generative capabilities in GPT.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: A) Encoder-based design; restricts output generation --- Reason: The encoder-based design inherently limits the model's ability to generate outputs effectively.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: C) Jointly optimizing masked token reconstruction and inter-sentence coherence discrimination --- Reason: This approach effectively integrates both masked token prediction and coherence tasks to enhance contextual understanding.}}}%
\par\noindent
...
\bigskip\par\noindent
\smash{\textcolor{white}{\tiny{Answer shown as correct: C)  --- Reason: Clearly aligns with how the concept is described in the question.}}}%
\par\noindent
